    ...
    steps = {
        "birth": {
            "started": Step(
                ...
                next_route=Routes.birth_request_name,
            ),
            "statement_completed": Step(
                label="Name",
                ordinal=1,
                previous_route=Routes.request_statement,
                next_route=Routes.birth_request_county,
            ),
            "name_completed": Step(
                label="County of birth",
                ordinal=2,
                previous_route=Routes.birth_request_name,
                next_route=Routes.birth_request_dob,
            ),
            "county_completed": Step(
                label="Date of birth",
                ordinal=3,
                previous_route=Routes.birth_request_county,
                next_route=Routes.birth_request_parents,
            ),
            "dob_completed": Step(
                label="Parents’ names",
                ordinal=4,
                previous_route=Routes.birth_request_dob,
                next_route=Routes.request_order,
            ),
            "parents_names_completed": Step(
                label="Order info",
                ordinal=5,
                previous_route=Routes.birth_request_parents,
        ...
        "marriage": {
            "started": Step(
                ...
                ordinal=None,
                previous_route=Routes.request_start,
                next_route=Routes.marriage_request_name,
            ),
            "statement_completed": Step(
                label="Name",
                ordinal=1,
                previous_route=Routes.request_statement,
                next_route=Routes.marriage_request_county,
            ),
            "name_completed": Step(
                label="County of marriage",
                ordinal=2,
                previous_route=Routes.marriage_request_name,
                next_route=Routes.marriage_request_date,
            ),
            "county_completed": Step(
                label="Date of marriage",
                ordinal=3,
                previous_route=Routes.marriage_request_county,
                next_route=Routes.request_order,
            ),
            "dob_completed": Step(
                label="Order info",
                ordinal=4,
                previous_route=Routes.marriage_request_date,
                next_route=Routes.request_submit,
            ),
            # `order_info_completed` always goes to `submitted`, so we don't need to specify `next_route` here
            # (it won't be used).
