...
class Routes:
    ...
    death_request_name = "death_request_name"
    death_request_county = "death_request_county"
    death_request_date = "death_request_date"
    death_request_dob = "death_request_dob"
    death_request_parent = "death_request_parent"
    death_request_spouse = "death_request_spouse"
