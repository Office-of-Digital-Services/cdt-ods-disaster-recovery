...
urlpatterns = [
    ...
    path("request/birth/<uuid:pk>/name", views.NameView.as_view(), name=Routes.birth_request_name),
    path("request/birth/<uuid:pk>/county", views.CountyView.as_view(), name=Routes.birth_request_county),
    path("request/birth/<uuid:pk>/dob", views.DateOfBirthView.as_view(), name=Routes.birth_request_dob),
    path("request/birth/<uuid:pk>/parents", views.ParentsNamesView.as_view(), name=Routes.birth_request_parents),
