...
TEMPLATE = os.path.join(settings.BASE_DIR, "web", "vital_records", "templates", "request", "SOE_B.pdf")
...
class PackageTask(Task):
    ...
    def handler(self, requestor_email: str):
        ...
        filename = os.path.join(settings.EMAIL_FILE_PATH, f"{package.package_id}.pdf")
